        ...
        <ul className={`grid py-6 w-full h-full ${cssClass}`}>
            ...
            {data.map((item, index) => (
                <li
                    key={index}
                    id={item.text}
                    className={`bg-secondary-50 w-full h-full flex flex-col justify-center items-center gap-5  rounded-lg shadow-sm ${styles.borderInsetWhite3} py-6 bg-secondary-50 `}
                >
                    {item.icon}
